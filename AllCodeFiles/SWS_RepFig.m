...
animalprefix = 'KL8';
animaldir = '/Volumes/JDSHIN/SingleDay/KL8_direct/';
eegdir = [animaldir,'EEG/'];
% addpath(genpath('C:\Users\wbtang\Desktop\HMM\Src_Matlab\'));
% addpath('/Users/wenbotang/Documents/Remote_HMM_files/Src_Matlab/Functions/');
