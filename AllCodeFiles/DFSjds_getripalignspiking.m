...
savefig1=0;
% val=6;savefile = [savedir 'Allanim_Coord250ca1ripplemod_by250mscrit_sleep_PFC_alldata_largewin']; area = 'PFC'; clr = 'b';
val=7;savefile = [savedir 'Allanim_Coord250ca1ripplemod_by250mscrit_sleep_CA1_alldata_largewin']; area = 'CA1'; clr = 'r';
...
%     animals = {'ZT2','JS17','JS21','AM2','JS34'};
    %Filter creation
    %-----------------------------------------------------
...
%             modf = setfilterfunction(modf,'DFAsj_getripalignspiking5',{'spikes', 'rippletime_noncoordSWS', 'tetinfo', 'pos'},'dospeed',0,'lowsp_thrs',4,'minrip',1); % Default stdev is 3
        ...
        case 6
            modf = setfilterfunction(modf,'DFAsj_getripalignspiking5',{'spikes', 'rippletime_coordSWS', 'tetinfo', 'pos'},'dospeed',0,'lowsp_thrs',4,'minrip',1); % Default stdev is 3
        case 7
            modf = setfilterfunction(modf,'DFAsj_getripalignspiking5',{'spikes', 'rippletime_coordSWS', 'tetinfo', 'pos'},'dospeed',0,'lowsp_thrs',4,'minrip',1); % Default stdev is 3
...
%         gatherdatafile = [savedir 'Allanim_noncoord250ca1ripplemod_by250mscrit_sleep_CA1_alldata_largewin_sepeps_gather_X6'];
    ...
    case 6
        ...
        gatherdatafile = [savedir 'Allanim_Coord250ca1ripplemod_by250mscrit_sleep_PFC_alldata_largewin_sepeps_gather_X6'];

    case 7
% 
        gatherdatafile = [savedir 'Allanim_Coord250ca1ripplemod_by250mscrit_sleep_CA1_alldata_largewin_sepeps_gather_X6'];
...
%     swronset=500; %CHANGE 
    ...
    for ii=1:cntcells
        ...
        % it goes from -500 to +500ms relative to ripples
        
%         curRastMat=zeros(numRips,1100); %CHANGE
        curRastMat=zeros(numRips,2200);
        
%         for i=1:numRips,curRastMat(i,round(curRast{i}+551))=1;end %CHANGE
...
%             curRastMatShuf=zeros(numRips,1100); %CHANGE
            curRastMatShuf=zeros(numRips,2200);
            
            for i=1:numRips
%                 shiftVal=round(rand(1)*1100); %CHANGE
...
%                 %CHANGE
            ...
            % shuffled "psth"
            meanRespShuf=filtfilt(b,1,mean(curRastMatShuf(:,50:end-50)));
...
%         meanResp=filtfilt(b,1,mean(curRastMat(:,50:1050))); %CHANGE
        meanResp=filtfilt(b,1,mean(curRastMat(:,50:2150)));
        %meanResp=filtfilt(b,1,mean(curRastMat));
